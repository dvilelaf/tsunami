...
"""This module contains the class to connect to the treasury contract."""
import logging
...
PUBLIC_ID = PublicId.from_str("dvilela/olas_treasury:0.1.0")
...
class OlasTreasuryContract(Contract):
    """The olas treasury contract."""
