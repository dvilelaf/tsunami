...
class BaseTsunamiTest(FSMBehaviourBaseCase):
    """Base test case."""

    path_to_skill = Path(__file__).parent.parent

    behaviour: TsunamiRoundBehaviour
    behaviour_class: Type[TsunamiBaseBehaviour]
    next_behaviour_class: Type[TsunamiBaseBehaviour]
...
class TestGetEventsBehaviour(BaseTsunamiTest):
    """Tests GetEventsBehaviour"""

    # TODO: set next_behaviour_class
    behaviour_class: Type[BaseBehaviour] = GetEventsBehaviour
...
class TestPublishTweetsBehaviour(BaseTsunamiTest):
    """Tests PublishTweetsBehaviour"""

    # TODO: set next_behaviour_class
    behaviour_class: Type[BaseBehaviour] = PublishTweetsBehaviour
    next_behaviour_class: Type[BaseBehaviour] = ...
