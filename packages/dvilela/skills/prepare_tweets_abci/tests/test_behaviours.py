...
from packages.dvilela.skills.prepare_tweets_abci.behaviours import (
    PrepareTweetsBaseBehaviour,
...
class BasePrepareTweetsTest(FSMBehaviourBaseCase):
    """Base test case."""

    path_to_skill = Path(__file__).parent.parent

    behaviour: PrepareTweetsRoundBehaviour
    behaviour_class: Type[PrepareTweetsBaseBehaviour]
    next_behaviour_class: Type[PrepareTweetsBaseBehaviour]
...
class TestPrepareTweetsBehaviour(BasePrepareTweetsTest):
    """Tests PrepareTweetsBehaviour"""

    # TODO: set next_behaviour_class
    behaviour_class: Type[BaseBehaviour] = PrepareTweetsBehaviour
