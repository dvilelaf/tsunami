...
"""This package contains the tests for rounds of PrepareTweets."""
...
class BasePrepareTweetsRoundTest(BaseRoundTestClass):
    """Base test class for PrepareTweets rounds."""
...
class TestPrepareTweetsRound(BasePrepareTweetsRoundTest):
    """Tests for PrepareTweetsRound."""

    round_class = PrepareTweetsRound
